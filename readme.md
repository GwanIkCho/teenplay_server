...
-   기본적으로 서비스는 고객들을에게 제공하는 것이고 고객들에게 맞춤으로 서비스를 제공하는 것이 중요하다.  
    이러한 상황에서 고객들의 개인정보는 매우 중요하다는 것을 느꼇습니다.

-   유저들의 정보 뿐만아니라 고객이 직접 입력하는 데이터들은 더 큰 가치를 가지고 있고 이것을 활용하여  
     고객에게 제공한다면 데이터를 더 가치있게 사용하는 것이라고 생각했습니다.
